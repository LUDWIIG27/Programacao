/*
	Faltou inicializar as variáveis BRA, PEL, FAR e IDD.
	A quantidade de torcedores com idade na faixa de 15 a 20 anos deveria
	ser contabilizada somente para torcedores do Brasil.
